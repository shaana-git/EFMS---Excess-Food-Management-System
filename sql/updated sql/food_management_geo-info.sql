...
CREATE TABLE `geo-info` (
  `uid` int NOT NULL,
  `ulat` decimal(12,9) NOT NULL,
  `ulong` decimal(12,9) NOT NULL,
...
INSERT INTO `geo-info` VALUES (2,12.952590000,80.141080000,'Individual'),(7,12.955070000,80.140440000,'Hotel'),(8,12.945350000,80.157110000,'Hotel'),(9,13.006600000,80.202520000,'Hotel');
